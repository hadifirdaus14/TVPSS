	...
	<div class="container">
		...
		<main class="content">
			...
			<section class="school-list">
				...
				<button onclick="addSchool.jsp" class="btn btn-add">Add
					School</button>
				<table>
					<thead>
						<tr>
					...
					<tbody>
						<c:forEach var="school" items="${schools}">
							<tr id="row${school.id}">
								...
								<td>
									<button class="btn btn-edit" onclick="editRecord(${school.id})">Edit</button>
									<button class="btn btn-delete"
										onclick="deleteRecord(${school.id})">Delete</button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
